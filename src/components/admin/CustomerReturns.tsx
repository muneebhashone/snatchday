...
import { Eye, Loader, Undo2 } from "lucide-react";
      ...
      {!returns?.data?.returns?.length ? (
        <div className="flex items-center justify-center min-h-[200px] text-gray-500">
          <div className="text-center">
            <Undo2 size={40} className="mx-auto mb-4 text-gray-400" />
            <p className="text-lg font-medium">No returns found</p>
            <p className="text-sm mt-2">
              This customer has no returns records yet
            </p>
          </div>
        </div>
      ) : (
        <>
          ...
          <div className="flex items-center justify-between py-4">
            <p className="text-sm text-gray-500">
              ...
              of {returns?.data?.total || 0} entries
            </p>
            <DynamicPagination
