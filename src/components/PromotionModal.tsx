...
export function PromotionModal() {
  ...
  return (
    // <DialogContent className="m-5 xl:max-w-[1920px] max-w-[1440px] max-h-[98vh] p-0 border-none overflow-auto">
    //   <DialogHeader
    ...
    //       </p>
    //     </DialogTitle>
    //   {/ <DialogClose className="bg-black p-2 absolute right-0 -top-3"/> /}
    //   </DialogHeader>
    ...
    //   </div>
    // </DialogContent>
    <DialogContent className="m-5 max-w-full max-h-full p-0 border-none flex flex-col overflow-auto bg-transparent items-center">
      <div className="max-w-[1920px] max-h-full mx-auto bg-white mt-5 mb-10 rounded-3xl scrollbar-hide">
        <DialogHeader
          style={{ backgroundImage: `url(${imageBg.src})` }}
          className="w-full bg-contain bg-no-repeat bg-center lg:bg-cover rounded-t-3xl h-max p-5 md:p-0 md:h-[280px] bg-[#3a094a] flex items-center justify-center"
        >
