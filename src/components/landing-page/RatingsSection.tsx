...
const RatingsSection = () => {
  return (
    <div className="bg-[#F6E9E1] py-28 lg:py-24 xl:py-28 px-8 lg:pl-10 xl:pr-40 2xl:px-40 h-full overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg-grid-cols-1 lg:gap-10 " >
        ...
        <div className="content-center col-span-1 lg:col-span-1 p-0 md:p-10 self-center justify-self-center">
          <RatingSlider />
        </div>
      </div>
    </div>
