    ...
    <div className="relative ">
      ...
      {isLoading ? (
        ...
        >
            ...
            {trainingCenter?.data?.map((card, index) => (
              ...
              >
                <div className="relative group cursor-pointer">
                  <div className="rounded-full my-6 shadow-lg border h-[150px] md:h-[220px] w-[150px] xl:h-[248px] 2xl:h-[278px] md:w-[220px] xl:w-[248px] 2xl:w-[278px] border-gray-200 hover:border-primary flex  items-center justify-center transition-transform transform group-hover:scale-105">
                    <Image
                      // className="w-[67px] sm:w-[60px] h-[67px] sm:h-[60px] md:w-[100px] md:h-[100px] xl:w-[200px] xl:h-[200px] object-contain"
                      className="object-contain w-[80px] md:h-[122px] h-[80px] md:w-[122px]"
                      src={card.logo}
                      alt={card.title}
                      width={122}
                      height={122}
          ...
          <CarouselPrevious className="w-14 sm:w-16 h-14 sm:h-16 md:w-20 xl:w-24 md:h-20 xl:h-24 bg-white shadow-lg border-0 text-gray-700 hover:bg-primary hover:text-white -left-10" />
          <CarouselNext className="w-14 sm:w-16 h-14 sm:h-16 md:w-20 xl:w-24 md:h-20 xl:h-24 bg-white shadow-lg border-0 text-gray-700 hover:bg-primary hover:text-white -right-10" />
        </Carousel>
      )}
    </div>
  );
