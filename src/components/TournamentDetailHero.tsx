      ...
      <div className="px-48 pt-28 pb-6 grid grid-cols-7 z-100 border-b border-b-[#e9f0ff]">
        <div className="col-span-4 flex gap-2 flex-col">
          ...
          <p className="text-2xl">
            ...
            <span className="text-primary">01.02.2025 at 18:31.</span> Check-out
            time: <span className="text-primary">18:21</span>
          </p>
          <div className="flex gap-5 w-max mt-7">
            <div className="border-2 border-dashed p-2 rounded-full flex gap-3">
              ...
              <div className="mr-14 flex flex-col">
                ...
                <h1 className="text-3xl text-primary font-bold">PowerBlocks</h1>
                <p className="text-lg">Duration: 3:00 minutes</p>
              </div>
            </div>
            <div className="border-2 border-dashed w-[400px] px-14 rounded-full flex items-center">
          ...
          <div className="flex gap-6 mt-3">
            <p className="border-2 border-dashed rounded-full px-8 py-1 text-[21px] ">
              Participation fee: <span className="text-primary">250</span>{" "}
              points / <span className="text-primary">2 .50€</span>
            </p>
            <h3 className="border-2 border-dashed rounded-full px-8 py-1 text-[21px] font-extrabold">
              50<span className="text-primary">€</span> Gunstiger
            </h3>
          </div>
          <div className="border border-gray-300 rounded-sm w-max py-3 flex gap-5 my-7">
          ...
          <div className="flex gap-3 items-start">
            ...
            <div className="flex flex-col gap-2">
              <div className="bg-primary py-3 px-10 rounded-full text-white text-[24px] leading-8 shadow-[0px_4px_10px_#F37835] cursor-pointer">
                <p>
                  Aktueller Preis{" "}
              ...
              <div className="flex gap-1">
                <TaxIcon />
                <p>incl. 19% VAT, plus shipping costs</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-center gap-1 md:gap-4 relative z-10 mt-10">
            {time?.map((item) => {
              return (
                ...
                >
                  <div
                    className={`bg-opacity-50 text-md sm:w-max lg:text-[45px] border px-2 lg:px-6 py-1 lg:py-4 mb-2 ${
                      item.timerText === "Days" &&
                      "border-none shadow-[1px_3px_10px_#d1d5db]"
                    }`}
                  >
                    <h1 className="">{item.timer}</h1>
                  </div>
        ...
        {/* <div className="col-span-3 z-100">
          <div className="space-y-4">
            <div className="bg-white p-8">
              <Image
                key={selectedImage} // Force re-render
                src={images[selectedImage]}
                alt="Product"
                width={500}
                height={500}
            ...
            <div className="flex gap-2 items-center justify-center">
              {images.map((image, index) => (
                <div
                  key={index}
                  className={`flex items-center justify-center p-2 bg-white rounded-xl border w-[100px] h-[92px] cursor-pointer transition-all duration-300 ${
                    selectedImage === index
                      ? "border-primary ring-[0.5px] ring-primary ring-opacity-50"
                      : "border-gray-200 hover:border-primary"
                  }`}
