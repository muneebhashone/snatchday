...
const RatingSlider = () => {
  ...
  return (
    <Carousel
      ...
      className="relative max-w-[600px] lg:max-w-[500px] xl:max-w-[700px] mb-24 xl:mb-0"
    >
      <CarouselContent>
        {reviews.map((review, index) => (
          <CarouselItem key={index}>
            <div className="bg-white px-16 lg:px-7 xl:px-16 shadow-sm rounded-xl pt-12 lg:pt-4 xl:pt-12 pb-16 lg:pb-2 xl:pb-16 w-full">
              ...
              <div className="flex sm:flex-row flex-col-reverse items-center justify-between gap-4 mb-6 border-b border-[#E0E0E0] pb-6">
                ...
                <div className="flex items-center justify-center gap-2 lg:gap-4 text-center">
                  ...
                  <Avatar className="w-20 xl:w-24 h-20 xl:h-24 text-md">
                  ...
                  <div>
                    ...
                    <h3 className="text-2xl lg:text-xl xl:text-2xl font-bold">
                      {review.name}
                    </h3>
                    <div className="flex text-2xl lg:text-xl xl:text-2xl text-[#FF6B3D]">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <ProvenExpertIcon />
                    <span className="text-2xl lg:text-xl xl:text-2xl text-black font-bold">
              ...
              <div className="flex flex-col-reverse xl:flex-row items-center justify-center gap-10">
                <div className="flex flex-col items-center justify-center md:mt-0 mt-5">
                  <p className="text-md sm:text-xl text-lg xl:text-xl mb-6">
                    {review.review}
                  </p>
                ...
                <Image
                  ...
                  className="xl:w-64 xl:h-72 lg:w-96 object-contain lg:h-48 w-48 h-56"
