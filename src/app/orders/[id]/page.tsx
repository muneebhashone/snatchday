...
const OrderStatusBadge = ({ status }) => {
  let color = "bg-gray-100 text-gray-800 capitalize";

  if (status?.toLowerCase().includes("delivered")) {
    color = "bg-green-100 text-green-800 capitalize";
  } else if (
    status?.toLowerCase().includes("shipped") ||
    status?.toLowerCase().includes("transit")
  ) {
    color = "bg-blue-100 text-blue-800 capitalize";
  } else if (status?.toLowerCase().includes("processing")) {
    color = "bg-yellow-100 text-yellow-800 capitalize";
  } else if (
    status?.toLowerCase().includes("cancelled") ||
    status?.toLowerCase().includes("returned")
  ) {
    color = "bg-red-100 text-red-800 capitalize";
  }
